...
dbconfig_passport = {
                'default':{#django自己的表
                    ...
                    'NAME': 'default_passport',  # Or path to database file if using sqlite3.
                ...
                'oauth_write':{#oauth写库
                    'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
                    'NAME': 'oauth_write',  # Or path to database file if using sqlite3.
                    'USER': 'sy',  # Not used with sqlite3.
                    'PASSWORD': 'sy123SY',  # Not used with sqlite3.
                    'HOST': mysql_db,  # Set to empty string for localhost. Not used with sqlite3.
                    'PORT': '3306',  # Set to empty string for default. Not used with sqlite3.
                ...
                'oauth_read':{#oauth读库
                    'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
                    'NAME': 'oauth_read',  # Or path to database file if using sqlite3.
                    'USER': 'sy',  # Not used with sqlite3.
                    'PASSWORD': 'sy123SY',  # Not used with sqlite3.
                    'HOST': mysql_db,  # Set to empty string for localhost. Not used with sqlite3.
                    'PORT': '3306',  # Set to empty string for default. Not used with sqlite3.
                ...
                'pay':{#支付库
                    'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
                    'NAME': 'pay_passport',  # Or path to database file if using sqlite3.
                    'USER': 'sy',  # Not used with sqlite3.
                    'PASSWORD': 'sy123SY',  # Not used with sqlite3.
                    'HOST': mysql_db,  # Set to empty string for localhost. Not used with sqlite3.
                    'PORT': '3306',  # Set to empty string for default. Not used with sqlite3.
                ...
                'common':{#通用库
                    'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
                    'NAME': 'common_passport',  # Or path to database file if using sqlite3.
                    'USER': 'sy',  # Not used with sqlite3.
                    'PASSWORD': 'sy123SY',  # Not used with sqlite3.
                    'HOST': mysql_db,  # Set to empty string for localhost. Not used with sqlite3.
                    'PORT': '3306',  # Set to empty string for default. Not used with sqlite3.
